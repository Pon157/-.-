        ...
        .responsive-image {
            ...
            test: {
                ...
                questions: [
                    ...
                    {
                        type: "multiple-choice",
                        question: "Что означает термин «уязвимость» в контексте эмпатии?",
                        options: [
                            "Слабость и беспомощность",
                            "Смелость быть настоящим и открытым",
                            "Неуверенность в себе",
                            "Зависимость от других"
                        ],
                        correct: 1,
                        explanation: "В контексте эмпатии уязвимость — это смелость быть открытым, искренним, принимать свои чувства и позволять себе понимать чувства другого. Это не слабость, а сила."
                    },
                    {
                        type: "true-false",
                        question: "Для проявления эмпатии нужно обязательно пережить точно такую же ситуацию, что и собеседник.",
                        correct: false,
                        explanation: "Не обязательно. Для эмпатии важно найти в своем опыте схожую эмоцию, а не идентичную ситуацию. Например, чтобы понять горечь увольнения, можно вспомнить, как вас исключили из команды в детстве."
                    },
                    {
                        type: "multiple-choice",
                        ...
                        options: [
                            ...
                            "Только сострадательная эмпатия"
                        ],
                        correct: 2,
                        explanation: "Идеально — баланс. Только эмоциональная эмпатия приведет к выгоранию, только когнитивная — к холодности. Сострадательная эмпатия помогает сохранить человечность и профессиональную эффективность."
                    },
                    {
                        type: "multiple-choice",
                        question: "Что такое проксемика?",
                        options: [
                            "Наука о жестах",
                            "Наука о дистанции между людьми",
                            "Наука о тоне голоса",
                            "Наука о выражении лица"
                        ],
                        correct: 1,
                        explanation: "Проксемика изучает дистанцию в общении. Для эмпатии важно соблюдать комфортную дистанцию: не слишком близко (нарушает границы), не слишком далеко (сигнализирует о холодности)."
                    },
                    {
                        type: "multiple-choice",
                        question: "Почему быстрый темп речи может мешать эмпатии?",
                        options: [
                            "Создает ощущение спешки и невнимательности",
                            "Слишком сложно понять быструю речь",
                            "Быстрая речь всегда неискренняя",
                            "Это не имеет значения для эмпатии"
                        ],
                        correct: 0,
                        explanation: "Быстрый темп речи часто воспринимается как нетерпение, желание поскорее закончить разговор. Эмпатичное общение обычно предполагает более медленный, вдумчивый темп."
                    },
                    {
                        type: "multiple-choice",
                        question: "Что из перечисленного НЕ является элементом невербальной эмпатии?",
                        options: [
                            "Отзеркаливание позы собеседника",
                            "Поддержание зрительного контакта",
                            "Быстрая речь с множеством советов",
                            "Спокойный и теплый тон голоса"
                        ],
                        correct: 2,
                        explanation: "Быстрая речь с множеством советов — это проявление нетерпения и желания контролировать ситуацию, что противоречит эмпатии. Эмпатичное общение предполагает медленный темп и слушание без немедленных советов."
                    },
                    {
                        type: "true-false",
                        question: "Сострадательная эмпатия всегда требует немедленного действия по решению проблемы другого человека.",
                        correct: false,
                        explanation: "Не всегда. Иногда сострадательная эмпатия может проявляться просто в присутствии и поддержке, без конкретных действий. Важно сначала понять, какая помощь действительно нужна."
                    },
                    {
                        type: "multiple-choice",
                        question: "Какой из этих ответов демонстрирует когнитивную эмпатию?",
                        options: [
                            "«Я тоже плачу, когда вижу твои слезы»",
                            "«Понимаю, почему ты так решил в этой ситуации»",
                            "«Дай я сделаю это за тебя»",
                            "«Не переживай, все будет хорошо»"
                        ],
                        correct: 1,
                        explanation: "«Понимаю, почему ты так решил» — это пример когнитивной эмпатии, когда мы интеллектуально понимаем точку зрения другого. Первый вариант — эмоциональная эмпатия, третий — спасение, четвертый — токсичная позитивность."
                    },
                    {
                        type: "multiple-choice",
                        question: "Что означает термин «эмоциональное заражение» в контексте эмпатии?",
                        options: [
                            "Сознательное принятие эмоций другого",
                            "Непроизвольное копирование эмоций собеседника",
                            "Намеренное вызывание эмоций у другого",
                            "Блокирование чужих эмоций"
                        ],
                        correct: 1,
                        explanation: "Эмоциональное заражение — это непроизвольный процесс, когда мы автоматически «заражаемся» эмоциями окружающих. Это биологический механизм, основанный на работе зеркальных нейронов."
                    },
                    {
                        type: "multiple-choice",
                        question: "Какая из этих реакций наиболее эмпатична на жалобу «Я так устал от всего»?",
                        options: [
                            "«Отдохни немного»",
                            "«У всех так бывает»",
                            "«Похоже, ты действительно на пределе»",
                            "«Тебе нужно взять отпуск»"
                        ],
                        correct: 2,
                        explanation: "«Похоже, ты действительно на пределе» — это отражение чувств (эмпатия). Первый и четвертый варианты — советы без эмпатии, второй — обесценивание."
                    }
                ],
                practical: {
                    ...
                    tasks: [
                        {
                            ...
                            scoringCriteria: [
                                "Отражает чувства (обида, боль, ощущение ненужности) — 3 балла",
                                "Использует слова говорящего («лучший друг», «день рождения», «ненужный») — 2 балла",
                                "Избегает обесценивания («не переживай», «ерунда») — 3 балла",
                                "Сохраняет позицию равенства (не жалость сверху) — 2 балла"
                            ],
                            maxPoints: 10
                        },
                        {
                            task: "Ситуация: ребенок упал с велосипеда и плачет. Разработайте 3 разных реакции: 1) с жалостью, 2) с сочувствием, 3) с эмпатией. Объясните различия.",
                            modelAnswer: "1) Жалость: «Бедненький, как же тебе больно!» (позиция сверху)\n2) Сочувствие: «Мне жаль, что ты упал» (внешнее наблюдение)\n3) Эмпатия: «Я вижу, как тебе больно. Упасть с велосипеда действительно страшно» (разделение чувств)",
                            scoringCriteria: [
                                "Правильно различает три типа реакций — 4 балла",
                                "Приводит конкретные примеры для каждого типа — 3 балла",
                                "Объясняет различия между типами — 3 балла"
                            ],
                            maxPoints: 10
                        }
                    ],
                ...
                additionalTasks: [
                    {
                        type: "analysis",
                        title: "Анализ фраз",
                        task: "Проанализируйте следующие фразы и определите, какая из них эмпатичная, а какая выражает жалость: 1) «Бедный, как тебе не повезло» 2) «Понимаю, как это обидно, когда тебя забывают» 3) «Не переживай, это ерунда»",
                        answer: "1 - жалость (позиция сверху, фокус на невезении), 2 - эмпатия (понимание чувств с позиции равенства), 3 - обесценивание (отрицание значимости чувств)",
                        scoringCriteria: [
                            "Правильно определяет все три фразы — 3 балла",
                            "Дает объяснение для каждого определения — 2 балла"
                        ],
                        maxPoints: 5
                    },
                    {
                        ...
                        task: "Ситуация: коллега говорит: «Я опоздал на важную встречу из-за пробок, начальник был в ярости». Напишите три разных ответа, демонстрирующих: а) когнитивную эмпатию, б) эмоциональную эмпатию, в) сострадательную эмпатию.",
                        modelAnswers: {
                        ...
                        scoringCriteria: [
                            "Правильно демонстрирует все три вида эмпатии — 6 баллов",
                            "Ответы соответствуют ситуациям — 4 балла"
                        ],
                        maxPoints: 10
                    }
                ],
        ...
        .responsive-image {
            ...
            test: {
                ...
                questions: [
                    ...
                    {
                        type: "true-false",
                        question: "Травма — это всегда объективно тяжелое событие.",
                        correct: false,
                        explanation: "Травма — это не само событие, а то, как оно было пережито. Два человека могут пережить одно и то же событие, и только у одного разовьется травма. Важна субъективная оценка и ресурсы психики в момент события."
                    },
                    {
                        type: "multiple-choice",
                        question: "Какая фраза является обесценивающей?",
                        options: [
                            "«Это действительно ужасно, что ты через это прошел»",
                            "«Другим еще хуже, чем тебе»",
                            "«Я здесь, если хочешь поговорить»",
                            "«Ты имеешь право на свои чувства»"
                        ],
                        correct: 1,
                        explanation: "Сравнение «другим хуже» обесценивает текущие страдания человека. Оно как бы говорит: «Твоя боль недостаточно значима, чтобы о ней говорить». Эмпатия признает уникальность каждого переживания."
                    },
                    {
                        type: "multiple-choice",
                        question: "Что НЕ рекомендуется делать при общении с пережившим травму?",
                        options: [
                            "Давать непрошеные советы",
                            "Слушать без оценки",
                            "Быть предсказуемым в реакциях",
                            "Уважать конфиденциальность"
                        ],
                        correct: 0,
                        explanation: "Непрошеные советы лишают человека контроля и могут усилить чувство беспомощности. Лучше спросить: «Хочешь услышать мои мысли по этому поводу?» или «Тебе нужно решение или просто выговориться?»"
                    },
                    {
                        type: "multiple-choice",
                        question: "Что такое «холдинг» в психологии?",
                        options: [
                            "Физическое удерживание человека",
                            "Способность «удерживать» эмоции другого",
                            "Техника остановки разговора",
                            "Метод лечения травмы"
                        ],
                        correct: 1,
                        explanation: "Холдинг (holding) — это способность быть контейнером для сильных эмоций другого, не разрушаясь под их тяжестью. Создание психологической «колыбели», где чувства могут быть безопасно прожиты."
                    },
                    {
                        type: "multiple-choice",
                        question: "Почему сравнение «А вот у других хуже» вредно?",
                        options: [
                            "Оно заставляет человека чувствовать себя виноватым",
                            "Оно обесценивает текущие переживания человека",
                            "Оно отвлекает от решения проблемы",
                            "Все вышеперечисленное"
                        ],
                        correct: 3,
                        explanation: "Эта фраза вызывает чувство вины («Я не имею права страдать»), обесценивает переживания («Моя боль не важна») и уводит от реальных чувств. Эмпатия не конечный ресурс — можно сопереживать и «тем, кому хуже», и человеку перед вами."
                    },
                    {
                        type: "multiple-choice",
                        question: "Какая из этих реакций наиболее поддерживает человека с травмой?",
                        options: [
                            "«Я знаю, что ты чувствуешь»",
                            "«Твои чувства важны и имеют право на существование»",
                            "«Просто забудь об этом»",
                            "«Другим было еще хуже»"
                        ],
                        correct: 1,
                        explanation: "Признание значимости чувств человека — ключевой элемент поддержки. Утверждение «Я знаю, что ты чувствуешь» может звучать как преуменьшение, а остальные варианты — токсичны."
                    },
                    {
                        type: "true-false",
                        question: "При общении с пережившим травму важно задавать много подробных вопросов о травмирующем событии.",
                        correct: false,
                        explanation: "Нет, это может ретравматизировать. Важно следовать за человеком: если он хочет говорить — слушать, если нет — не давить. Лучше спрашивать: «Хочешь рассказать об этом?»"
                    },
                    {
                        type: "multiple-choice",
                        question: "Что означает принцип «не навреди» в контексте общения с пережившим травму?",
                        options: [
                            "Не говорить вообще ничего",
                            "Избегать любой эмоциональной вовлеченности",
                            "Осознавать, что наши слова могут усугубить страдания",
                            "Направлять только к профессионалам"
                        ],
                        correct: 2,
                        explanation: "Принцип «не навреди» означает осознание, что даже с благими намерениями мы можем сказать что-то, что усилит боль. Лучше меньше, но осознаннее."
                    },
                    {
                        type: "multiple-choice",
                        question: "Какой из этих признаков указывает на создание безопасного пространства?",
                        options: [
                            "Человек начинает говорить быстрее",
                            "Человек избегает зрительного контакта",
                            "Тело человека расслабляется",
                            "Человек часто перебивает"
                        ],
                        correct: 2,
                        explanation: "Расслабление тела — физиологический признак того, что человек чувствует себя в безопасности. Напряжение, избегание взгляда и быстрая речь — признаки дискомфорта."
                    },
                    {
                        type: "multiple-choice",
                        question: "Что такое «вторичная травматизация» помогающего?",
                        options: [
                            "Когда помогающий сам переживает травму",
                            "Когда помогающий испытывает симптомы, похожие на травму, после работы с пострадавшими",
                            "Когда помогающий травмирует клиента",
                            "Когда помогающий забывает о травме клиента"
                        ],
                        correct: 1,
                        explanation: "Вторичная травматизация (vicarious trauma) — это когда помогающий, работая с травмированными людьми, начинает испытывать симптомы, похожие на ПТСР. Важно иметь границы и заботиться о себе."
                    }
                ],
                practical: {
                    ...
                    tasks: [
                        {
                            ...
                            scoringCriteria: [
                                "Признает нормальность реакции — 3 балла",
                                "Избегает обесценивания («пора двигаться») — 3 балла",
                                "Поддерживает право на индивидуальный темп — 2 балла",
                                "Не дает непрошеных советов — 2 балла"
                            ],
                            maxPoints: 10
                        },
                        {
                            task: "Ситуация: ваш друг пережил автомобильную аварию месяц назад. Он боится садиться в машину. Разработайте план поддержки из 5 шагов, который помогает, но не давит.",
                            modelAnswer: "1. Спросить: «Хочешь поговорить о своем страхе?»\n2. Признать чувства: «После аварии страх — естественная реакция»\n3. Предложить маленькие шаги: «Может, сначала просто посидеть в неподвижной машине?»\n4. Уважать темп: «Делай это в своем ритме»\n5. Быть рядом: «Я здесь, если понадобится поддержка»",
                            scoringCriteria: [
                                "План включает уважение выбора — 3 балла",
                                "Предлагает постепенные шаги — 3 балла",
                                "Признает чувства без обесценивания — 2 балла",
                                "Оставляет контроль у друга — 2 балла"
                            ],
                            maxPoints: 10
                        }
                    ],
                ...
                additionalTasks: [
                    {
                        type: "transformation",
                        title: "Трансформация фраз",
                        task: "Переформулируйте токсичные фразы в поддерживающие: 1) «Не плачь, все образуется» 2) «Хватит ныть, возьми себя в руки» 3) «Забудь и живи дальше»",
                        modelAnswers: {
                            1: "«Слезы — это нормальная реакция на боль. Я здесь с тобой.»",
                            2: "«Похоже, тебе действительно тяжело. Хочешь рассказать, что именно давит больше всего?»",
                            3: "«Это часть твоей истории. Ты имеешь право чувствовать все, что чувствуешь.»"
                        },
                        scoringCriteria: [
                            "Правильно преобразует все три фразы — 6 баллов",
                            "Новые фразы сохраняют поддержку — 4 балла"
                        ],
                        maxPoints: 10
                    },
                    {
                        type: "situation",
                        title: "Кейс-анализ",
                        task: "Ситуация: коллега рассказывает, как ее публично унизил начальник на совещании. Она плачет и говорит: «Я больше не могу здесь работать». Проанализируйте ошибки и предложите эмпатичный подход.",
                        modelAnswer: "Ошибки: 1) Сказать «Не принимай близко к сердцу» (обесценивание) 2) «Увольняйся!» (совет без запроса) 3) «У всех такие начальники» (сравнение).\nЭмпатичный подход: «Публичное унижение — это ужасно. Должно быть, тебе очень больно и стыдно. Хочешь рассказать подробнее или просто поплакать? Я здесь.»",
                        scoringCriteria: [
                            "Определяет минимум 2 ошибки — 4 балла",
                            "Предлагает эмпатичный подход — 4 балла",
                            "Объясняет разницу — 2 балла"
                        ],
                        maxPoints: 10
                    }
                ],
        ...
        .responsive-image {
            ...
            test: {
                ...
                questions: [
                    ...
                    {
                        type: "multiple-choice",
                        question: "Какой невербальный сигнал показывает активное слушание?",
                        options: [
                            "Постоянная проверка телефона",
                            "Скрещенные руки на груди",
                            "Легкие кивки головой",
                            "Откинутая назад поза"
                        ],
                        correct: 2,
                        explanation: "Легкие кивки (не быстрые и частые, которые выглядят как нетерпение) показывают: «Я слежу за твоей мыслью, продолжай». Это невербальное «угу»."
                    },
                    {
                        type: "true-false",
                        question: "Активное молчание — это когда вы просто молчите, не показывая интереса.",
                        correct: false,
                        explanation: "Активное молчание — это присутствие: зрительный контакт, открытая поза, внимательное выражение лица. Это молчание говорит: «Я здесь, я с тобой, продолжай, когда будешь готов»."
                    },
                    {
                        type: "multiple-choice",
                        question: "Какой из этих вопросов лучше переформулировать?",
                        options: [
                        ...
                        correct: 0,
                        explanation: "«Почему» лучше заменить на «что» или «как». Например: «Что привело к такому решению?» или «Как ты принял это решение?»"
                    },
                    {
                        type: "multiple-choice",
                        question: "Что такое «эхо-техника»?",
                        options: [
                            "Кричать, чтобы перекричать собеседника",
                            "Повторять последние слова с вопросительной интонацией",
                            "Использовать громкий голос",
                            "Повторять все сказанное слово в слово"
                        ],
                        correct: 1,
                        explanation: "Эхо-техника: повторить 1-2 последних слова с вопросительной интонацией. «Я так устал...» — «Устал?..» Это побуждает продолжить, показывает интерес."
                    },
                    {
                        type: "multiple-choice",
                        question: "Сколько секунд рекомендуется выдерживать паузу перед ответом?",
                        options: [
                            "1-2 секунды",
                            "3-5 секунд",
                            "10-15 секунд",
                        ...
                        correct: 1,
                        explanation: "3-5 секунд — оптимальная пауза. Меньше — кажется, что перебиваешь; больше — становится неловко. Эта пауза дает время подумать и показывает, что вы обдумываете сказанное."
                    }
                ],
                practical: {
                    ...
                    scoringCriteria: [
                        "Отражение ключевых чувств («беспокоит», «ссоры», «взаимопонимание») — 4 балла",
                ...
                additionalTasks: [
                    {
                        type: "transformation",
                        task: "Преобразуйте закрытые вопросы в открытые: 1) Ты расстроен? 2) Тебе помочь? 3) Это было сложно? 4) Ты согласен со мной?",
                        modelAnswers: {
                            1: "«Что ты чувствуешь?» или «Расскажи о своих переживаниях»",
                            2: "«Чем я могу быть полезен?» или «Какая помощь была бы сейчас уместна?»",
                            3: "«Что было самым сложным?» или «Как ты справлялся с трудностями?»",
                            4: "«Как ты относишься к этой идее?» или «Что ты думаешь по этому поводу?»"
                        },
                        points: 8
                    },
                    {
        ...
        .responsive-image {
            ...
            test: {
                ...
                questions: [
                    ...
                    {
                        type: "true-false",
                        question: "Я-сообщения — это способ говорить о своих чувствах без обвинений.",
                        correct: true,
                        explanation: "Формула Я-сообщения: «Я чувствую X, когда ты делаешь Y, потому что Z. Я хотел(а) бы W.» Например: «Я тревожусь, когда ты задерживаешься, потому что беспокоюсь о тебе. Давай договоримся звонить, если задерживаешься.»"
                    },
                    {
                        type: "multiple-choice",
                        question: "Что такое экологичное предложение помощи?",
                        options: [
                            "Предложение, которое навязывается",
                            "Предложение, дающее выбор и уважающее отказ",
                            "Предложение с условиями и требованиями",
                            "Предложение, которое нельзя отклонить"
                        ],
                        correct: 1,
                        explanation: "Экологичное предложение: «Хочешь...?», «Может быть...?», «Если тебе откликается...». Оно легко принимается И легко отклоняется без чувства вины."
                    },
                    {
                        type: "multiple-choice",
                        question: "Какой вопрос лучше задать, прежде чем предлагать помощь?",
                        options: [
                            "«Ты чего такой беспомощный?»",
                            "«Чем я могу быть полезен?»",
                            "«Почему ты сам не справляешься?»",
                            "«Когда ты уже научишься?»"
                        ],
                        correct: 1,
                        explanation: "«Чем я могу быть полезен?» — золотой вопрос. Он дает человеку контроль (он решает, какая помощь нужна) и предотвращает непрошеную помощь."
                    },
                    {
                        type: "multiple-choice",
                        question: "Что означает «дать удочку, а не рыбу»?",
                        options: [
                            "Научить человека помогать себе самому",
                            "Сделать все за человека",
                            "Критиковать за беспомощность",
                            "Игнорировать проблемы человека"
                        ],
                        correct: 0,
                        explanation: "«Дать удочку» — научить навыку, дать инструмент, поддержать самостоятельность. «Дать рыбу» — решить проблему за человека, создав зависимость."
                    },
                    {
                        type: "multiple-choice",
                        question: "Когда помощь становится спасением?",
                        options: [
                            "Когда вы делаете то, что человек может сделать сам",
                            "Когда вы помогаете по просьбе",
                            "Когда вы уважаете отказ",
                            "Когда вы даете выбор"
                        ],
                        correct: 0,
                        explanation: "Если человек МОЖЕТ сделать сам (даже если медленно, даже если с ошибками), а вы делаете за него — это спасение. Вы лишаете его опыта, роста, уверенности в себе."
                    }
                ],
                practical: {
...
Вы: «Хочешь, я буду рядом, пока ты выносишь мусор? Или предпочитаешь делать это сам?»`,
                    scoringCriteria: [
                        "Спрашивает, а не навязывает — 3 балла",
                        "Предлагает маленькие шаги — 3 балла",
                        "Дает выбор (рядом/сам) — 2 балла",
                        "Не берет на себя уборку — 2 балла"
                    ],
                    maxPoints: 10
                },
                additionalTasks: [
                    {
                        type: "analysis",
                        task: "Проанализируйте ситуации и определите, где помощь, а где спасение: 1) Ребенок не может завязать шнурки. Вы завязываете за него. 2) Ребенок не может завязать шнурки. Вы садитесь рядом и говорите: «Давай попробуем вместе. Видишь эту петлю?»",
                        answer: "1 — спасение (делаете за него), 2 — помощь (учите, поддерживаете самостоятельность)",
                        points: 5
                    },
                    {
                        type: "situation",
                        task: "Ситуация: ваш взрослый сын постоянно просит денег в долг и не возвращает. Напишите, как вы установите границы, предложив помощь в поиске работы или составлении бюджета, но отказываясь давать деньги.",
        ...
        .responsive-image {
            ...
            test: {
                ...
                questions: [
                    ...
                    {
                        type: "true-false",
                        question: "Личные границы — это эгоизм.",
                        correct: false,
                        explanation: "Границы — не эгоизм, а забота о себе и отношениях. Эгоизм — «только я важен». Границы — «я важен, ты важен, наши потребности разные, давай договоримся»."
                    },
                    {
                        type: "multiple-choice",
                        question: "Что помогает завершить цикл стресса?",
                        options: [
                            "Скроллинг соцсетей",
                        ...
                        correct: 1,
                        explanation: "Физическая активность (прогулка, танцы, растяжка) помогает вывести гормоны стресса из тела. Скроллинг, работа и игнорирование — не завершают цикл, а загоняют стресс глубже."
                    },
                    {
                        type: "multiple-choice",
                        question: "Какой из признаков указывает на начало выгорания?",
                        options: [
                            "Повышенный энтузиазм",
                            "Частые болезни и усталость",
                            "Улучшение концентрации",
                            "Повышенная работоспособность"
                        ],
                        correct: 1,
                        explanation: "Ранние признаки выгорания: хроническая усталость, частые простуды (иммунитет снижается), проблемы со сном, раздражительность. Энтузиазм и работоспособность — признаки начального этапа работы."
                    },
                    {
                        type: "multiple-choice",
                        question: "Что такое усталость от сострадания?",
                        options: [
                            "Обычная физическая усталость",
                            "Истощение от постоянного контакта с чужими страданиями",
                            "Нежелание помогать другим",
                            "Лень и апатия"
                        ],
                        correct: 1,
                        explanation: "Усталость от сострадания (compassion fatigue) — специфическое истощение у помогающих, когда способность к эмпатии снижается из-за постоянного контакта с чужими страданиями. Это профессиональный риск."
                    },
                    {
                        type: "multiple-choice",
                        question: "Почему границы делают эмпатию возможной?",
                        options: [
                            "Потому что они защищают от близости",
                            "Потому что они предотвращают выгорание",
                            "Потому что они делают человека холодным",
                            "Потому что они ограничивают общение"
                        ],
                        correct: 1,
                        explanation: "Парадокс: самые эмпатичные люди имеют самые четкие границы. Границы защищают от выгорания, дают возможность восстанавливаться, и поэтому человек может быть эмпатичным долгосрочно."
                    }
                ],
                practical: {
                    ...
                    scoringCriteria: [
                        "Использует Я-сообщение — 3 балла",
                        "Четко говорит о своих пределах — 3 балла",
                        "Предлагает конструктивные альтернативы — 2 балла",
                ...
                additionalTasks: [
                    {
                        type: "plan",
                        task: "Составьте личный план профилактики выгорания на месяц. Включите: 1) Ежедневные практики, 2) Еженедельные ритуалы, 3) Признаки, по которым поймете, что нужен перерыв, 4) К кому обратитесь за помощью.",
...
4) За помощью: к супервизору, к психологу, к коллеге для взаимной поддержки.`,
                    ...
                    {
                        type: "situation",
                        task: "Ситуация: ваш друг звонит вам каждый день поздно вечером, чтобы «выговориться» о своих проблемах. Вы чувствуете истощение. Напишите, как вы установите границы, сохраняя заботу о друге.",
...
5) «Я знаю, что ты чувствуешь» → «Я не могу полностью понять, но я пытаюсь.»`,
        ...
        scoring: {
            ...
            practical: "75 баллов (15 баллов за каждое задание, всего 5 заданий)",
            total: "105 баллов",
            passing: "От 75 баллов - успешное прохождение",
            grades: {
                "A": "95-105 баллов (отлично)",
                "B": "85-94 балла (очень хорошо)",
                "C": "75-84 балла (удовлетворительно)",
                "F": "менее 75 баллов (не сдано)"
            }
        }
    }
};

// Добавляем CSS для темной темы (остается без изменений)
...
function checkAssignment(submoduleId) {
    alert("Задание отправлено на проверку! В полной версии курса здесь была бы автоматическая проверка.");
}
...
// Функция для отображения контрольной работы
function showTest(moduleId) {
    ...
    let html = `
        <div class="test-container">
            ...
            <div class="test-info">
                <p><strong>Всего вопросов:</strong> ${test.questions.length}</p>
                <p><strong>Максимальный балл:</strong> ${test.totalPoints}</p>
        ...
        html += `
            <div class="test-question">
                ...
                ${q.type === 'multiple-choice' ? 
                    q.options.map((opt, i) => `
                        <div style="margin: 5px 0; padding: 5px; background: ${i === q.correct ? '#1e3a1e' : '#2a2a2a'}; border-radius: 4px;">
                            ${opt} ${i === q.correct ? '✓' : ''}
                        </div>
                    `).join('') : 
    ...
    html += `<h2>Практическая часть (${exam.scoring.practical})</h2>`;
    exam.practicalTasks.forEach((task, index) => {
        html += `
            <div class="test-question">
                <p><strong>Задание ${index + 1}: ${task.task}</strong></p>
                ...
                <textarea placeholder="Напишите ваш ответ здесь..." style="min-height: 150px;"></textarea>
            </div>
        `;
    });
    ...
    html += `
        <div style="text-align: center; margin: 30px 0;">
            <button class="btn-primary" style="font-size: 1.2em; padding: 15px 30px;" onclick="submitFinalExam()">
                Отправить итоговый экзамен
            </button>
        </div>
    </div>
    `;
    
    console.log(html); // Для демонстрации
    return html;
}

function submitFinalExam() {
    alert("Итоговый экзамен отправлен! В полной версии будет подробный разбор результатов и сертификат.");
}

// Экспорт данных курса для использования в других частях приложения
