// БАЗА ЗНАНИЙ ДЛЯ ПРОВЕРКИ ЗАДАНИЙ
const knowledgeBase = {
    // Модуль 1.1
    "1.1": {
        assignment: {
            ...
            keywords: {
                required: ["жалость", "эмпатия", "разница", "позиция"],
                жалость: ["жалко", "бедняжка", "сверху", "сверху вниз", "дистанция", "неравенство", "жалеть"],
                эмпатия: ["понимаю", "вместе", "равный", "равные", "вместе чувствовать", "эмпатия", "сопереживание", "на месте"],
                примеры: ["фраза", "пример", "ситуация", "сказать", "ответ"]
            },
            modelAnswer: "Жалость: «Бедняжка, как тебе не повезло с проектом» (позиция сверху, создает дистанцию). Эмпатия: «Понимаю твое разочарование, я бы тоже расстроился на твоем месте» (позиция равных, разделение чувств)."
        },
        quiz: {
            "q1": {
                ...
                correctAnswer: "b",
                options: {
                    "a": "Эмпатия — это позиция сверху, жалость — позиция равных",
                    "b": "Эмпатия — это позиция равных, жалость — позиция сверху",
                    "c": "Между ними нет существенной разницы"
                }
            },
            "q2": {
                question: "Какие утверждения верны об эмпатии?",
                correctAnswers: ["a", "b", "d"],
                options: {
                    "a": "Требует уязвимости и открытости",
                    "b": "Это способ «чувствовать вместе»",
                    "c": "Всегда включает в себя решение проблемы за другого",
                    "d": "Укрепляет отношения"
                }
            }
        }
    },
    ...
    "1.2": {
        assignment: {
            ...
            keywords: {
                required: ["когнитивная", "эмоциональная", "сострадательная", "пример"],
                когнитивная: ["понимаю", "интеллектуально", "мыслю", "знаю", "когнитивная", "умом"],
                эмоциональная: ["чувствую", "эмоционально", "зеркальные нейроны", "сопереживаю", "эмоции"],
                сострадательная: ["помочь", "поддержать", "действие", "конструктивно", "сострадание", "забота"],
                ситуация: ["потерял работу", "друг", "безработный", "уволили"]
            },
            modelAnswer: "Когнитивная: «Понимаю, как сложно потерять работу в нынешней экономической ситуации». Эмоциональная: «Я чувствую твою тревогу и растерянность». Сострадательная: «Давай подумаем, как я могу поддержать тебя в поиске новой работы»."
        },
        quiz: {
            "q1": {
                ...
                correctAnswer: "b",
                options: {
                    "a": "Когнитивная эмпатия",
                    "b": "Эмоциональная эмпатия",
                    "c": "Сострадательная эмпатия"
                }
            },
            "q2": {
                question: "Какие утверждения верны о зеркальных нейронах?",
                correctAnswers: ["a", "b", "d"],
                options: {
                    "a": "Активируются при выполнении действия",
                    "b": "Активируются при наблюдении за действием другого",
                    "c": "Отвечают только за логическое мышление",
                    "d": "Являются основой эмоциональной эмпатии"
                }
            },
            "q3": {
                ...
                correctAnswer: "b",
                options: {
                    "a": "Эмоциональная эмпатия",
                    "b": "Когнитивная эмпатия",
                    "c": "Сострадательная эмпатия"
                }
            }
        }
    ...
    "1.3": {
        assignment: {
            ...
            keywords: {
                required: ["эмпатия", "чувства", "отразить", "понимаю"],
                отражение: ["устал", "прессинг", "не понимают", "не способен"],
                чувства: ["усталость", "давление", "одиночество", "беспомощность", "непонимание"],
                конструкция: ["похоже", "чувствую", "понимаю", "должно быть", "вижу"],
                избегать: ["совет", "решение", "не переживай", "ерунда", "взбодрись"]
            },
            modelAnswer: "Похоже, ты чувствуешь себя истощенным от постоянного давления и одиночества. Должно быть, тяжело, когда кажется, что тебя никто не понимает и не ценит."
        },
        quiz: {
            "q1": {
                ...
                correctAnswer: "b",
                options: {
                    "a": "Умение быстро отвечать",
                    "b": "Совпадение слов и невербальных сигналов",
                    "c": "Способность говорить красиво"
                }
            },
            "q2": {
                question: "Какие из этих невербальных сигналов показывают эмпатию?",
                correctAnswers: ["a", "c"],
                options: {
                    "a": "Наклон тела к собеседнику",
                    "b": "Скрещенные руки на груди",
                    "c": "Умеренный зрительный контакт",
                    "d": "Проверка телефона во время разговора"
                }
            },
            "q3": {
    ...
    "2.1": {
        assignment: {
            question: "Объясните разницу между событием и травмой",
            keywords: {
                required: ["событие", "травма", "реакция", "нервная система", "разница"],
                событие: ["ДТП", "авария", "происшествие", "факт", "внешнее"],
                травма: ["реакция", "последствие", "внутреннее", "переживание", "психика", "застряло"],
                индивидуальность: ["по-разному", "индивидуально", "зависит", "восприятие", "ресурсы"],
                пример: ["один", "другой", "первый", "второй", "пример"]
            },
            modelAnswer: "Событие — это внешний факт (например, ДТП). Травма — это внутренняя реакция нервной системы, когда опыт «застревает» и продолжает влиять на жизнь. Для одного человека ДТП может быть просто неприятным событием, для другого — травмой, вызывающей панику при виде машин."
        },
        quiz: {
            "q1": {
                ...
                options: {
                    "a": "Лекарство от ПТСР",
                    "b": "Стимул, вызывающий воспоминание о травме",
                    "c": "Тип психотерапии"
                }
            },
            "q2": {
                question: "Какие утверждения верны о травме?",
                correctAnswers: ["a", "c"],
                options: {
                    "a": "Травма — это реакция нервной системы на событие",
                    "b": "Все люди одинаково реагируют на одинаковые события",
                    "c": "Ко-регуляция помогает успокоить нервную систему",
                    "d": "Травма всегда проявляется одинаково у всех людей"
                }
            },
            "q3": {
                question: "Что важно при общении с человеком, пережившим травму?",
                correctAnswer: "b",
                options: {
                    "a": "Быть терапевтом и решать его проблемы",
                    "b": "Быть «стабильным объектом» и сохранять спокойствие",
                    "c": "Заставлять говорить о травме для «проработки»"
                }
            }
        }
    },
    ...
    "2.2": {
        assignment: {
            question: "Составьте список фраз, которых стоит избегать",
            keywords: {
                required: ["фразы", "избегать", "токсичная", "позитивность", "обесценивание"],
                количество: ["4", "четыре", "несколько", "список"],
                типы: ["все будет хорошо", "не переживай", "у других хуже", "возьми себя в руки", "не думай об этом", "время лечит", "будь сильным"],
                объяснение: ["токсичная", "обесценивание", "вред", "не помогает", "ухудшает"]
            },
            modelAnswer: "1. «Все будет хорошо» — токсичная позитивность. 2. «У других проблемы серьезнее» — обесценивание. 3. «Не думай об этом» — отрицание чувств. 4. «Возьми себя в руки» — давление и отсутствие эмпатии."
        },
        quiz: {
            "q1": {
                ...
                correctAnswer: "b",
                options: {
                    "a": "Позитивное мышление, которое всегда помогает",
                    "b": "Навязывание позитивных эмоций и отрицание негативных",
                    "c": "Способ быстро выйти из депрессии"
                }
            },
            "q2": {
                question: "Какие из этих фраз представляют токсичную позитивность?",
                correctAnswers: ["a", "b", "d"],
                options: {
                    "a": "«Все будет хорошо»",
                    "b": "«У других еще хуже»",
                    "c": "«Похоже, тебе действительно тяжело»",
                    "d": "«Улыбнись, не грусти»"
                }
            },
            "q3": {
                question: "Почему фраза «У других проблемы серьезнее» вредна?",
                correctAnswer: "c",
                options: {
                    "a": "Она обесценивает чувства человека",
                    "b": "Она заставляет чувствовать вину за свои переживания",
                    "c": "И то, и другое"
                }
            }
        }
    ...
    "2.3": {
        assignment: {
            question: "Придумайте диалог с поддержкой без давления",
            keywords: {
                required: ["диалог", "поддержка", "без давления", "друг", "авария"],
                элементы: ["спросить", "предложить", "выбор", "уважать", "не навязывать"],
                безопасность: ["хочешь", "может быть", "как ты смотришь", "если захочешь"],
                давление: ["должен", "надо", "обязан", "срочно", "немедленно", "заставлять"]
            },
            modelAnswer: "Я: «Как ты себя чувствуешь сейчас, когда думаешь о машине?» Друг: «До сих пор страшно...» Я: «Это понятно после такого опыта. Хочешь, попробуем вместе подойти к машине? Или сначала просто поговорим об этом?»"
        },
        quiz: {
            "q1": {
                ...
                correctAnswer: "b",
                options: {
                    "a": "Быстро решить проблему человека",
                    "b": "Обеспечить контроль и выбор самому человеку",
                    "c": "Дать множество советов"
                }
            },
            "q2": {
                ...
                correctAnswers: ["a", "b", "d"],
                options: {
                    "a": "Слушать без перебивания",
                    "b": "Сохранять конфиденциальность",
                    "c": "Оценивать чувства как правильные/неправильные",
                    "d": "Уважать паузы и молчание"
                }
            },
            "q3": {
                question: "Что такое «холдинг» в психологии?",
                correctAnswer: "a",
                options: {
                    "a": "Способность удерживать эмоции другого без разрушения",
                    "b": "Техника физического удерживания человека",
                    "c": "Метод быстрого решения проблем"
                }
            }
        }
    }
...
// УСОВЕРШЕНСТВОВАННАЯ ФУНКЦИЯ ПРОВЕРКИ ЗАДАНИЙ
function checkAssignment(submoduleId) {
    ...
    if (!answerElement || !feedbackElement) {
        console.error("Элементы ответа или обратной связи не найдены");
        return;
    }
    ...
    // Проверяем, есть ли задание в базе знаний
    if (!knowledgeBase[submoduleId] || !knowledgeBase[submoduleId].assignment) {
        showFeedback(feedbackElement, "⚠️ Задание не найдено в базе знаний. Проверка невозможна.", false);
        return;
    }
    
    const assignmentData = knowledgeBase[submoduleId].assignment;
    const keywords = assignmentData.keywords;
    const userAnswer = answer.toLowerCase();
    
    // Проверка по ключевым словам
    let score = 0;
    let maxScore = 0;
    let feedback = `<h4>Проверка задания: ${assignmentData.question}</h4>`;
    let missingKeywords = [];
    
    // Проверяем обязательные ключевые слова
    if (keywords.required) {
        maxScore += keywords.required.length * 2;
        keywords.required.forEach(keyword => {
            if (userAnswer.includes(keyword.toLowerCase())) {
                score += 2;
                feedback += `<p>✅ <strong>${keyword}</strong> - присутствует</p>`;
            } else {
                missingKeywords.push(keyword);
                feedback += `<p>❌ <strong>${keyword}</strong> - отсутствует</p>`;
            }
        });
    }
    
    // Проверяем остальные категории ключевых слов
    Object.keys(keywords).forEach(category => {
        if (category !== 'required' && Array.isArray(keywords[category])) {
            ...
            maxScore += 1;
            if (categoryFound) {
                feedback += `<p>✅ Категория <strong>${category}</strong> - отражена</p>`;
            } else {
                missingKeywords.push(`категория "${category}"`);
                feedback += `<p>❌ Категория <strong>${category}</strong> - не отражена</p>`;
            }
        }
    });
    ...
    if (percentage >= 70) {
        feedback += `<p style="color: #2ecc71; font-weight: bold;">✅ Отлично! Вы набрали ${score} из ${maxScore} баллов (${percentage}%)</p>`;
        feedback += `<p>Пример правильного ответа: <em>${assignmentData.modelAnswer}</em></p>`;
        
        // Если авторизован, очищаем черновик
        if (isAuthenticated && currentUserId) {
            clearDraft(submoduleId);
        }
    } else if (percentage >= 40) {
        feedback += `<p style="color: #f39c12; font-weight: bold;">📝 Хорошо, но можно лучше: ${score} из ${maxScore} баллов (${percentage}%)</p>`;
        feedback += `<p>Не хватает: ${missingKeywords.join(', ')}</p>`;
        feedback += `<p>Пример правильного ответа: <em>${assignmentData.modelAnswer}</em></p>`;
    } else {
        feedback += `<p style="color: #e74c3c; font-weight: bold;">❌ Нужно доработать: ${score} из ${maxScore} баллов (${percentage}%)</p>`;
        feedback += `<p>Вы не раскрыли основные аспекты задания. Обратите внимание на: ${missingKeywords.join(', ')}</p>`;
        feedback += `<p>Изучите теорию еще раз и попробуйте снова.</p>`;
    }
    
    showFeedback(feedbackElement, feedback, percentage >= 70);
}

// ФУНКЦИЯ ПРОВЕРКИ ТЕСТОВ С ВЫБОРОМ ОТВЕТА
function checkQuiz(submoduleId) {
    ...
    // Проверяем, есть ли тест в базе знаний
    if (!knowledgeBase[submoduleId] || !knowledgeBase[submoduleId].quiz) {
        showFeedback(feedbackElement, "⚠️ Тест не найден в базе знаний. Проверка невозможна.", false);
        return;
    }
    ...
    Object.keys(quizData).forEach(questionKey => {
        ...
        const questionNumber = parseInt(questionKey.replace('q', '')) || 1;
        
        // Получаем ответы пользователя
        let userAnswers;
        if (question.correctAnswers) { // Множественный выбор
            userAnswers = [];
            const checkboxes = document.querySelectorAll(`input[name="q${questionNumber}_${submoduleId.replace('.', '_')}"]:checked`);
            checkboxes.forEach(cb => userAnswers.push(cb.value));
        } else { // Одиночный выбор
            const radio = document.querySelector(`input[name="q${questionNumber}_${submoduleId.replace('.', '_')}"]:checked`);
            userAnswers = radio ? radio.value : null;
        }
        
        // Проверяем правильность
        let isCorrect = false;
        if (question.correctAnswers) {
            isCorrect = arraysEqual(userAnswers.sort(), question.correctAnswers.sort());
        } else {
            isCorrect = userAnswers === question.correctAnswer;
        }
        
        if (isCorrect) {
            score++;
            feedbackHTML += `<p>✅ Вопрос ${questionNumber}: Верно!</p>`;
        } else {
            feedbackHTML += `<p>❌ Вопрос ${questionNumber}: Неверно. `;
            if (question.correctAnswers) {
                feedbackHTML += `Правильные ответы: ${question.correctAnswers.map(a => question.options[a]).join(', ')}`;
            } else {
                feedbackHTML += `Правильный ответ: ${question.options[question.correctAnswer]}`;
            }
            feedbackHTML += `</p>`;
        }
    });
    ...
    if (percentage >= 70) {
        ...
        // Если авторизован, отмечаем прогресс
        if (isAuthenticated && currentUserId) {
            updateProgress(submoduleId, true);
        }
    ...
    showFeedback(feedbackElement, feedbackHTML, percentage >= 70);
}
...
function checkExtraAssignment(submoduleId) {
    ...
    // Для дополнительных заданий используем упрощенную проверку
    const feedbackId = 'extra-feedback' + submoduleId.replace('.', '_');
    let feedbackElement = document.getElementById(feedbackId);
    
    if (!feedbackElement) {
        // Создаем элемент для обратной связи, если его нет
        const extraTask = document.querySelector(`[onclick*="checkExtraAssignment('${submoduleId}')"]`);
        if (extraTask && extraTask.parentNode) {
            feedbackElement = document.createElement('div');
            feedbackElement.id = feedbackId;
            feedbackElement.className = 'feedback';
            extraTask.parentNode.appendChild(feedbackElement);
        } else {
            console.error("Элемент дополнительного задания не найден");
            return;
        }
    }
    
    // Собираем все ответы из textarea
    const textareas = feedbackElement.parentNode.querySelectorAll('textarea');
    let allFilled = true;
    let totalAnswers = 0;
    let filledAnswers = 0;
    ...
    if (!allFilled) {
        showFeedback(feedbackElement, `❌ Заполнено ${filledAnswers} из ${totalAnswers} ответов. Пожалуйста, заполните все поля.`, false);
        return;
    }
    
    // Базовая проверка по длине ответов
    let qualityScore = 0;
    textareas.forEach(textarea => {
    ...
    const qualityPercentage = Math.round((qualityScore / totalAnswers) * 100);
    
    if (qualityPercentage >= 70) {
        showFeedback(feedbackElement, `✅ Отлично! Вы дали развернутые ответы. Это хорошая практика для закрепления материала.`, true);
    } else {
        showFeedback(feedbackElement, `📝 Хорошо, но попробуйте дать более развернутые ответы. Чем подробнее вы отвечаете, тем лучше усваивается материал.`, false);
    }
}
...
function updateProgress(submoduleId, isCompleted) {
    // Обновляем прогресс пользователя
    if (isAuthenticated && currentUserId && userProgress) {
        // Добавляем подмодуль в список завершенных
        if (!userProgress.completedSubmodules) {
            userProgress.completedSubmodules = [];
        }
        
        if (isCompleted && !userProgress.completedSubmodules.includes(submoduleId)) {
            userProgress.completedSubmodules.push(submoduleId);
            
            // Сохраняем в localStorage
            localStorage.setItem(`userProgress_${currentUserId}`, JSON.stringify(userProgress));
...
// ФУНКЦИЯ ДЛЯ ОБЪЕДИНЕНИЯ ВСЕХ ТЕКСТОВЫХ ПОЛЕЙ
function mergeTextareas(submoduleId) {
    const textareas = document.querySelectorAll(`textarea[id^="extra${submoduleId.replace('.', '_')}"]`);
    if (textareas.length > 0) {
        let mergedText = '';
        textareas.forEach((textarea, index) => {
            if (textarea.value.trim()) {
                mergedText += `Ответ ${index + 1}: ${textarea.value.trim()}\n\n`;
            }
        });
...
// ДОБАВЛЯЕМ ГЛОБАЛЬНЫЕ ОБЪЕКТЫ (если их нет)
...
if (!window.isAuthenticated) {
    ...
    window.answerDraftsCache = new Map();
}
...
console.log(`✅ База знаний содержит ${Object.keys(knowledgeBase).length} модулей`);
console.log("✅ Все функции проверки доступны глобально");

// СТИЛИ ДЛЯ РАЗДЕЛЕНИЯ ТЕОРИИ И ПРАКТИКИ
...
<style>
    ...
    /* ИСТОЧНИКИ (внизу страницы, мельче) */
    .sources-container {
        margin-top: 40px;
        padding-top: 20px;
...
document.head.insertAdjacentHTML('beforeend', separationStyles);

// ФУНКЦИЯ ДЛЯ ПРЕОБРАЗОВАНИЯ СОДЕРЖИМОГО ПОДМОДУЛЯ
function enhanceSubmoduleContent(content, submoduleId) {
    // Находим место для вставки разделителя
    const tempDiv = document.createElement('div');
    tempDiv.innerHTML = content;
    
    // Находим заголовки
    const theoryHeadings = tempDiv.querySelectorAll('h3');
    const practiceHeadings = tempDiv.querySelectorAll('h4');
    
    let enhancedContent = content;
    
    // Добавляем разделитель перед практикой
    if (practiceHeadings.length > 0) {
        const practiceHeading = practiceHeadings[0];
        const practiceText = practiceHeading.textContent.toLowerCase();
        
        if (practiceText.includes('задание') || practiceText.includes('практика') || practiceText.includes('тест')) {
            const divider = `<div class="section-divider"></div><div class="practice-section">`;
            enhancedContent = enhancedContent.replace(practiceHeading.outerHTML, divider + practiceHeading.outerHTML);
            
            // Закрываем секцию практики в конце
            enhancedContent += '</div>';
            
            // Обертываем теорию в отдельный блок
            const theoryEnd = enhancedContent.indexOf(divider);
            if (theoryEnd > 0) {
                const theoryPart = enhancedContent.substring(0, theoryEnd);
                const practicePart = enhancedContent.substring(theoryEnd);
                
                enhancedContent = `<div class="theory-section">${theoryPart}</div>${practicePart}`;
            }
        }
    }
    ...
    const checkingInfo = `
        <div class="checking-info">
            <h4>📋 Как проверяется задание:</h4>
            <ul>
                <li>✅ Проверяется по ключевым словам из базы знаний</li>
                <li>✅ Требуется не менее 70% совпадений</li>
                <li>✅ Учитывается глубина и полнота ответа</li>
                <li>✅ После проверки вы увидите подробный анализ</li>
            </ul>
            <p><small>Система проверяет наличие основных понятий и их правильное применение.</small></p>
        </div>
    `;
    
    // Вставляем информацию о проверке перед первым заданием
    const assignmentIndex = enhancedContent.indexOf('textarea');
    if (assignmentIndex > 0) {
        enhancedContent = enhancedContent.substring(0, assignmentIndex) + checkingInfo + enhancedContent.substring(assignmentIndex);
    }
    
    // Добавляем источники внизу (если они есть в исходном контенте)
    const sourceBoxes = tempDiv.querySelectorAll('.source-box');
    if (sourceBoxes.length > 0) {
        let sourcesHTML = '<div class="sources-container"><div class="sources-title">Источники и литература</div>';
        
        sourceBoxes.forEach((source, index) => {
            // Извлекаем текст из source-box
            const sourceText = source.textContent.trim();
            sourcesHTML += `<div class="source-item">${sourceText}</div>`;
            
            // Удаляем исходный source-box из контента
            enhancedContent = enhancedContent.replace(source.outerHTML, '');
        });
        
        sourcesHTML += '</div>';
        enhancedContent += sourcesHTML;
    }
    
    return enhancedContent;
}

// ЭКСПОРТ ФУНКЦИИ ДЛЯ УЛУЧШЕНИЯ КОНТЕНТА
window.enhanceSubmoduleContent = enhanceSubmoduleContent;

console.log("✅ Система разделения теории и практики загружена");
console.log("✅ Функция enhanceSubmoduleContent доступна для улучшения контента");

// ПРИМЕР ИСПОЛЬЗОВАНИЯ В КОНТЕКСТЕ ЗАГРУЗКИ ПОДМОДУЛЯ:
/*
function loadSubmodule(submoduleId) {
    // ... получение данных подмодуля ...
    
    // Улучшаем контент перед отображением
    const enhancedContent = enhanceSubmoduleContent(submodule.content, submoduleId);
    
    // Отображаем улучшенный контент
    document.getElementById('content-area').innerHTML = enhancedContent;
    
    // Инициализируем проверку заданий
    initializeAssignmentChecking(submoduleId);
}
*/

// ИНИЦИАЛИЗАЦИЯ ПРОВЕРКИ ЗАДАНИЙ ДЛЯ ТЕКУЩЕГО ПОДМОДУЛЯ
function initializeAssignmentChecking(submoduleId) {
    console.log(`Инициализация проверки для подмодуля ${submoduleId}`);
    
    // Убедимся, что обработчики событий назначены
    const checkButtons = document.querySelectorAll(`button[onclick*="checkAssignment('${submoduleId}')"]`);
    ...
    const textareas = document.querySelectorAll(`textarea[id^="answer${submoduleId.replace('.', '_')}"], 
                                               textarea[id^="extra${submoduleId.replace('.', '_')}"]`);
    textareas.forEach(textarea => {
        if (!textarea.hasAttribute('title')) {
            textarea.setAttribute('title', 'Пишите подробно, используя термины из теории. Система проверяет ключевые слова.');
            textarea.setAttribute('placeholder', 'Напишите развернутый ответ... (чем подробнее, тем лучше)');
        }
    });
}
...
window.assignmentUtils = {
    ...
    checkAnswerLength: function(answer, minLength = 50) {
        return answer.length >= minLength;
    },
    
    // Подсчет ключевых слов в ответе
    countKeywords: function(answer, keywords) {
    ...
    evaluateAnswer: function(answer, submoduleId) {
        const data = knowledgeBase[submoduleId];
        if (!data || !data.assignment) return { score: 0, maxScore: 0 };
        
        const keywords = data.assignment.keywords;
        let score = 0;
        let maxScore = 0;
        
        // Проверка длины
        if (this.checkAnswerLength(answer)) {
            score += 10;
        }
        maxScore += 10;
        ...
        Object.keys(keywords).forEach(category => {
            if (Array.isArray(keywords[category])) {
                const found = this.countKeywords(answer, keywords[category]);
                const categoryMax = keywords[category].length;
    ...
    // Генерация подсказки по улучшению ответа
    generateHint: function(answer, submoduleId) {
        const data = knowledgeBase[submoduleId];
        if (!data || !data.assignment) return "Обратитесь к материалу урока.";
        
        const keywords = data.assignment.keywords;
        const lowerAnswer = answer.toLowerCase();
        const missing = [];
        
        // Находим недостающие ключевые слова
        Object.keys(keywords).forEach(category => {
            if (Array.isArray(keywords[category])) {
                keywords[category].forEach(keyword => {
                    if (!lowerAnswer.includes(keyword.toLowerCase())) {
        ...
        if (missing.length > 0) {
            return `Попробуйте включить в ответ: ${missing.slice(0, 5).join(', ')}...`;
        }
        
        return "Ответ хороший, но можно добавить больше примеров и деталей.";
    }
};

console.log("✅ Утилиты для проверки заданий загружены");
console.log("✅ Система готова к работе. Для использования:");
console.log("1. Используйте enhanceSubmoduleContent() для улучшения контента");
console.log("2. Вызывайте initializeAssignmentChecking() после загрузки подмодуля");
console.log("3. Используйте checkAssignment(), checkQuiz() для проверки");
