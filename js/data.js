...
// Контрольная работа 1 - Дополненная
const test1 = {
    ...
    additionalTasks: [
        {
            ...
            answer: "1 - жалость, 2 - эмпатия, 3 - обесценивание"
        },
        {
            type: "situation",
...
// Контрольная работа 2 - Дополненная
const test2 = {
    ...
    additionalTasks: [
        {
            type: "analysis",
            task: "Составьте список из 5 фраз, которых следует избегать при общении с человеком, пережившим травму, и для каждой предложите альтернативную, поддерживающую фразу.",
            example: "Избегать: «Забудь и живи дальше» → Альтернатива: «Это часть твоей истории, и ты имеешь право чувствовать все, что чувствуешь»"
        },
        {
            type: "situation",
...
// Контрольная работа 3 - Дополненная
const test3 = {
...
// Контрольная работа 4 - Дополненная
const test4 = {
    ...
    additionalTasks: [
        {
            type: "transformation",
            task: "Переформулируйте фразы спасения в фразы помощи: 1) «Дай, я сам все сделаю» 2) «Ты должен слушаться меня» 3) «Я знаю лучше, что тебе нужно»"
        },
        {
            type: "situation",
...
// Контрольная работа 5 - Дополненная
const test5 = {
...
const finalExam = {
    ...
    scoring: {
        theory: "20 баллов (1 балл за каждый правильный ответ)",
        practical: "50 баллов (10 баллов за каждое задание)",
        total: "70 баллов",
        passing: "От 50 баллов - успешное прохождение"
    }
};
