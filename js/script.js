...
async function initApp() {
    try {
        // 🔥 ИСПРАВЛЕНИЕ: Данные курса уже загружены в data.js
        // Проверяем, что courseData действительно существует
        console.log('📥 Проверка данных курса...');
        
        if (typeof courseData === 'undefined') {
            console.error('❌ courseData не загружен! Убедитесь, что data.js подключен перед script.js');
            
            // Создаем минимальную структуру для предотвращения ошибок
            window.courseData = {
            ...
            console.log('✅ Данные курса загружены:', courseData.title);
        }
        // -----------------------------------------------------------
