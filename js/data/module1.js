            ...
            content: `<div class="theory-block">
                ...
                <div class="good-bad-table-container">
                    <table class="good-bad-table">
                        ...
                        <tr>
                            <td class="good-cell">«Я понимаю, как тебе тяжело»</td>
                            <td class="bad-cell">«Бедняжка, как тебе не повезло»</td>
                        </tr>
                        <tr>
                            <td class="good-cell">«Это действительно больно, когда тебя не понимают»</td>
                            <td class="bad-cell">«Не переживай, это ерунда»</td>
                        </tr>
                        <tr>
                            <td class="good-cell">«Я бы чувствовал то же самое на твоем месте»</td>
                            <td class="bad-cell">«У других проблемы серьезнее»</td>
                        </tr>
                        <tr>
                            <td class="good-cell">«Твои чувства важны и имеют значение»</td>
                            <td class="bad-cell">«Просто забудь об этом»</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="assignment" data-submodule="1.1">
                    <h4>📝 Задание:</h4>
            ...
            content: `<div class="theory-block">
                ...
                <div class="good-bad-table-container">
                    <table class="good-bad-table">
                        ...
                        <tr>
                            <td class="good-cell">Понимать чувства другого, сохраняя свои границы</td>
                            <td class="bad-cell">Полностью растворяться в чужих эмоциях</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Использовать эмпатию для поддержки и помощи</td>
                            <td class="bad-cell">Использовать понимание для манипуляции</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Балансировать между пониманием и действием</td>
                            <td class="bad-cell">Игнорировать свои потребности ради других</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Признавать свои ограничения в помощи</td>
                            <td class="bad-cell">Брать ответственность за решение чужих проблем</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="assignment" data-submodule="1.2">
                    <h4>📝 Задание:</h4>
            ...
            content: `<div class="theory-block">
                ...
                <div class="good-bad-table-container">
                    <table class="good-bad-table">
                        ...
                        <tr>
                            <td class="good-cell">Наклон корпуса к собеседнику</td>
                            <td class="bad-cell">Скрещенные руки и ноги</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Спокойный, теплый тон голоса</td>
                            <td class="bad-cell">Быстрый, нервный темп речи</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Соответствующее выражение лица</td>
                            <td class="bad-cell">Улыбка, когда человек плачет</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Умеренный зрительный контакт</td>
                            <td class="bad-cell">Избегание зрительного контакта</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="assignment" data-submodule="1.3">
                    <h4>📝 Задание:</h4>
