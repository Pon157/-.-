            ...
            content: `<div class="theory-block">
                ...
                <div class="good-bad-table-container">
                    <table class="good-bad-table">
                        ...
                        <tr>
                            <td class="good-cell">Быть спокойным и предсказуемым</td>
                            <td class="bad-cell">Давить на откровенность</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Уважать личные границы</td>
                            <td class="bad-cell">Давать непрошеные советы</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Предлагать конкретную помощь</td>
                            <td class="bad-cell">Минимизировать переживания</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Слушать без осуждения</td>
                            <td class="bad-cell">Требовать быстрого восстановления</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="assignment" data-submodule="2.1">
                    <h4>📝 Задание:</h4>
                    <p><strong>Объясните разницу между событием и травмой</strong></p>
            ...
            content: `<div class="theory-block">
                ...
                <div class="good-bad-table-container">
                    <table class="good-bad-table">
                        ...
                        <tr>
                            <td class="good-cell">Признавать сложные чувства</td>
                            <td class="bad-cell">Требовать позитивного мышления</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Слушать без осуждения</td>
                            <td class="bad-cell">Сравнивать с более тяжелыми случаями</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Предлагать конкретную помощь</td>
                            <td class="bad-cell">Давать непрошеные советы</td>
                        ...
                        <tr>
                            <td class="good-cell">Уважать индивидуальный темп восстановления</td>
                            <td class="bad-cell">Торопить с восстановлением</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="assignment" data-submodule="2.2">
                    <h4>📝 Задание:</h4>
                    <p><strong>Составьте список фраз, которых стоит избегать</strong></p>
            ...
            content: `<div class="theory-block">
                ...
                <div class="good-bad-table-container">
                    <table class="good-bad-table">
                        ...
                        <tr>
                            <td class="good-cell">Слушать без оценки</td>
                            <td class="bad-cell">Давать оценки и суждения</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Уважать конфиденциальность</td>
                            <td class="bad-cell">Обсуждать с другими</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Быть предсказуемым и стабильным</td>
                            <td class="bad-cell">Реагировать непредсказуемо</td>
                        </tr>
                        <tr>
                            <td class="good-cell">Давать выбор и контроль</td>
                            <td class="bad-cell">Навязывать свои решения</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="assignment" data-submodule="2.3">
                    <h4>📝 Задание:</h4>
                    <p><strong>Придумайте диалог с поддержкой без давления</strong></p>
