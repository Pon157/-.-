...
app.post('/telegram-webhook', async (req, res) => {
  try {
    ...
    res.sendStatus(200); // Все равно отвечаем 200, чтобы Telegram не спамил
  }
});
...
const startBot = async () => {
  try {
    ...
    // Запускаем бота в режиме polling (без вебхука)
    ...
    app.listen(PORT, () => {
      ...
      console.log(`📢 Используйте команду /start в Telegram`);
    });
